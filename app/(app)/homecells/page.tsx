...
export default function HomecellsRoute() {
  ...
  function openEditModal(homecell: HomecellRecord) {
    ...
    setForm({
      ...
      meeting_time: homecell.meeting_time ? homecell.meeting_time.slice(0, 5) : "",
          ...
          >
            <form id="homecellForm" onSubmit={handleSubmit}>
              <div className="row">
                ...
                <Field className="col-md-6" label="Meeting Day" value={form.meeting_day} onChange={(value) => updateForm("meeting_day", value)} />
                <Field className="col-md-6" label="Meeting Time" type="time" value={form.meeting_time} onChange={(value) => updateForm("meeting_time", value)} />
...
function formatMeeting(homecell: HomecellRecord) {
  ...
  return [homecell.meeting_day, homecell.meeting_time ? formatTime(homecell.meeting_time) : null]
    .filter(Boolean)
    .join(", ");
}
