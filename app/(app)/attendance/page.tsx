...
export default function AttendanceRoute() {
  ...
  useEffect(() => {
    ...
    async function bootstrap() {
      ...
      try {
        ...
        setServices(
          ((churchResponse.data.service_schedules || []) as ServiceScheduleRecord[])
            .slice()
  ...
  }, [churchId, form.branchId, form.serviceDate]);
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const nextBranchId = sessionBranchId ? String(sessionBranchId) : "";
      setForm(emptyAttendanceForm(nextBranchId));

      const [summaryResponse, recordsResponse] = await Promise.all([
        fetchAttendanceSummary(churchId, nextBranchId ? Number(nextBranchId) : undefined, "weekly"),
        fetchAttendanceRecords(churchId, nextBranchId ? Number(nextBranchId) : undefined, 5),
      ]);
    ...
    <div className="container-fluid">
      <div className="row">
            ...
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                  ...
                  <p className="text-secondary mb-0">Enter attendance counts for today&apos;s service. System auto-calculates totals.</p>
                </div>
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-header">
              <h5 className="mb-0"><i className="ti ti-calendar me-2" />Select Service</h5>
            </div>
            <div className="card-body">
              <div className="row">
        ...
        <div className="col-lg-8">
          <div className="card">
            <div className="card-header">
              <h5 className="mb-0"><i className="ti ti-users me-2" />Attendance Figures</h5>
            </div>
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-flex gap-2">
                  ...
                  <button
                    ...
                    onClick={() => setForm(emptyAttendanceForm(sessionBranchId ? String(sessionBranchId) : ""))}
                    type="button"
                  >
                    Clear Form
                  </button>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="d-grid gap-2">
                <Link className="btn btn-light-success" href="/add-member">
                  <i className="ti ti-user-plus me-1" />
                  Add Member
                </Link>
                <Link className="btn btn-light-warning" href="/homecell-attendance">
                ...
                <table className="table table-hover align-middle mb-0">
                  ...
                  <tbody>
                    {records.length > 0 ? (
                      ...
                      <tr>
                        <td className="text-center text-muted py-4" colSpan={10}>No attendance records yet.</td>
                      </tr>
                    )}
                  </tbody>
                </table>
